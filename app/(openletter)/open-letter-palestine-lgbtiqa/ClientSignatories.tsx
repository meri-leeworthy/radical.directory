...
export function ClientSignatories({
  end,
  length,
  messages,
}: {
  ...
  console.log("rendering ClientSignatories", end)
  ...
  if (isLoading)
    return (
      <div className="flex items-center gap-2">
        ...
        <svg
          aria-hidden="true"
          className="w-4 h-4 text-black animate-spin fill-pink-600"
          viewBox="0 0 100 101"
          fill="none"
  ...
  const messagesToCheck = [...(messages || []), ...data?.chunk]
  ...
  console.log("ends compared", end, data.end)
